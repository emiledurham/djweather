...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get(
            f"https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode={zipcode}&distance=5&API_KEY={api_key}")
        ...
        if api[0]['AQI'] == -1:
            category_description = "There was an error getting the air quality. Try a different Zipcode?"
        ...
        api_request = requests.get(
             f'https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=95405&distance=5&API_KEY={api_key}')
